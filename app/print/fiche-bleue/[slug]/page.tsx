        ...
        <div className="fb-content">
          ...
          <div className="fb-header">
            ...
            <div className="fb-header-right">
              ...
              <div className="fb-doc-date">{numeroLabel} · {formatDate(dateDocument || data.date)}</div>
              {data.reference && (
                <div className="fb-doc-date" style={{fontStyle: "italic"}}>Réf. {data.reference}</div>
              )}
            </div>
          </div>
